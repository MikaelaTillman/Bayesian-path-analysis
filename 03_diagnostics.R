...
pp_check(mod_cent, resp = "spring", type = "ribbon", x = "dens_cent")
pp_check(mod_cent, resp = "spring", type = "ribbon_grouped", x = "dens_cent", group = "yr")
...
pp_check(mod_cent, resp = "fall", type = "ribbon", x = "dens_cent")
...
pp_check(mod_cent, resp = "success", type = "ribbon", x = "dens_cent")
...
pp_check(mod_cent, type = "error_scatter_avg_vs_x", size = 1.1, x = "dens_cent", resp = "spring")
pp_check(mod_cent, type = "error_scatter_avg_vs_x", size = 1.1, x = "max_snow_m_cent", resp = "spring")

pp_check(mod_cent, type = "error_scatter_avg_vs_x", size = 1.1, x = "dens_cent", resp = "success")
...
pp_check(mod_cent, type = "error_scatter_avg_vs_x", size = 1.1, x = "dens_cent", resp = "fall")
...
pp_check(mod_org, resp = "spring")  # shows dens_overlay plot by default
pp_check(mod_org, resp = "spring", type = "error_hist", ndraws = 11)
pp_check(mod_org, resp = "spring", type = "stat_2d")
pp_check(mod_org, resp = "spring", type = "loo_pit")
...
pp_check(mod_org, resp = "fall")  # shows dens_overlay plot by default
pp_check(mod_org, resp = "fall", type = "error_hist", ndraws = 11)
pp_check(mod_org, resp = "fall", type = "stat_2d")
pp_check(mod_org, resp = "fall", type = "loo_pit")
